...
class TestVoiceProcessor:
    ...
    @patch("voice_processor.dotenv_values")
    def test_download_requires_credentials(self, mock_dotenv):
    ...
    def test_download_success(self, mock_get, mock_dotenv):
    ...
    @patch("voice_processor.dotenv_values")
    @patch("voice_processor.requests.get")
    def test_download_failure_raises(self, mock_get, mock_dotenv):
...
class TestTranscribeAudio:
    ...
    def test_transcription_pipeline(self, mock_download, mock_dotenv, mock_groq_cls):
        """Full transcription pipeline with mocks."""
        mock_dotenv.return_value = {"GROQ_API_KEY": "test-key"}
    ...
    @patch("voice_processor.dotenv_values")
    @patch.object(VoiceProcessor, "_download_twilio_media_sync")
    def test_missing_groq_key_raises(self, mock_download, mock_dotenv):
